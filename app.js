...
const HDR_ENVS = [
  ...
  // ── Additional indoor / residential environments ─────────────────────────────
  {
    label: 'Lounge',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/lythwood_lounge_1k.hdr',
    sunDir: new THREE.Vector3(-0.5, 1.5, 1).normalize(),
    sunColor: 0xffcc80,
    sunIntensity: 1.0,
    hemiSky: 0xffd090,
    hemiGnd: 0x604030,
  ...
  {
    label: 'Home Room',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/lythwood_room_1k.hdr',
    sunDir: new THREE.Vector3(1, 1.5, 0.5).normalize(),
    sunColor: 0xffe4b8,
    sunIntensity: 0.9,
    hemiSky: 0xffe0d0,
  ...
  {
    label: 'Wooden Lounge',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/wooden_lounge_1k.hdr',
    sunDir: new THREE.Vector3(0.5, 1, 1).normalize(),
    sunColor: 0xffba60,
    sunIntensity: 1.1,
    hemiSky: 0xffcc80,
    hemiGnd: 0x584030,
  ...
  },
  {
    ...
    sunDir: new THREE.Vector3(0, 0.5, 1).normalize(),
    sunColor: 0xff8030,
    sunIntensity: 1.5,
    hemiSky: 0xffa050,
    hemiGnd: 0x502010,
  ...
  {
    label: 'Cozy Café',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/comfy_cafe_1k.hdr',
    sunDir: new THREE.Vector3(-1, 1.5, 0.5).normalize(),
    sunColor: 0xffcc80,
    sunIntensity: 1.0,
    hemiSky: 0xffd098,
  ...
  {
    label: 'Warm Restaurant',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/warm_restaurant_1k.hdr',
    sunDir: new THREE.Vector3(0.5, 2, 0.5).normalize(),
    sunColor: 0xffb860,
    sunIntensity: 1.2,
    hemiSky: 0xffc080,
    hemiGnd: 0x502818,
  ...
  {
    label: 'Log Cabin',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/cabin_1k.hdr',
    sunDir: new THREE.Vector3(1.5, 1, 0.5).normalize(),
    sunColor: 0xffe0a0,
    sunIntensity: 1.2,
    hemiSky: 0xffd080,
    hemiGnd: 0x604020,
  ...
  {
    label: 'Reading Room',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/reading_room_1k.hdr',
    sunDir: new THREE.Vector3(-0.5, 1.5, 0.5).normalize(),
    sunColor: 0xffd080,
    sunIntensity: 0.8,
    hemiSky: 0xffc880,
    hemiGnd: 0x504038,
  ...
  {
    label: 'Vintage Room',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/old_room_1k.hdr',
    sunDir: new THREE.Vector3(1, 1.5, -0.5).normalize(),
    sunColor: 0xffb050,
    sunIntensity: 0.7,
    hemiSky: 0xffb868,
  ...
  {
    label: 'Window Blinds',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/blinds_1k.hdr',
    sunDir: new THREE.Vector3(1.5, 1, 0).normalize(),
    sunColor: 0xfff4e0,
    sunIntensity: 1.3,
    hemiSky: 0xfff0e0,
    hemiGnd: 0x506050,
  ...
  {
    label: 'En Suite',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/en_suite_1k.hdr',
    sunDir: new THREE.Vector3(0, 1.5, 0.5).normalize(),
    sunColor: 0xfff8f0,
    sunIntensity: 0.9,
    hemiSky: 0xfff0f0,
    hemiGnd: 0x484848,
  ...
  {
    label: 'Veranda',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/veranda_1k.hdr',
    sunDir: new THREE.Vector3(-1, 1.5, 1).normalize(),
    sunColor: 0xfff0c8,
    sunIntensity: 1.5,
    hemiSky: 0xffe8c0,
  ...
  {
    label: 'Pine Attic',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/pine_attic_1k.hdr',
    sunDir: new THREE.Vector3(0, 1.5, 0.5).normalize(),
    sunColor: 0xffd090,
    sunIntensity: 1.0,
    hemiSky: 0xffcc80,
  ...
  {
    label: 'Warm Bar',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/warm_bar_1k.hdr',
    sunDir: new THREE.Vector3(0.5, 1.5, -0.5).normalize(),
    sunColor: 0xffaa50,
    sunIntensity: 1.1,
    hemiSky: 0xffb068,
  ...
  {
    label: 'Anniversary Lounge',
    url: 'https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/anniversary_lounge_1k.hdr',
    sunDir: new THREE.Vector3(-0.5, 2, 0.5).normalize(),
    sunColor: 0xffe0b8,
    sunIntensity: 1.0,
    hemiSky: 0xffe0c8,
  ...
  // ── Table / Studio environments ──────────────────────────────────────────────
  {
    label: 'Monochrome Studio',
    url: 'https://raw.githubusercontent.com/mrdoob/three.js/dev/examples/textures/equirectangular/monochrome_studio_02_1k.hdr',
    sunDir: new THREE.Vector3(0, 1, 0.5).normalize(),
    sunColor: 0xffffff,
    sunIntensity: 0.8,
    hemiSky: 0xffffff,
    hemiGnd: 0xcccccc,
  ...
  },
  {
    ...
    sunDir: new THREE.Vector3(-0.5, 1, 0.5).normalize(),
    sunColor: 0xffffff,
    sunIntensity: 0.9,
    hemiSky: 0xffffff,
    hemiGnd: 0xaaaaaa,
  ...
  },
  {
    ...
    sunDir: new THREE.Vector3(1, 2, 0.5).normalize(),
    sunColor: 0xfff0d0,
    sunIntensity: 1.2,
    hemiSky: 0xffe8c8,
    hemiGnd: 0x604830,
